...
@Component({
  selector: 'app-advertiser-forgot',
  templateUrl: './advertiser-forgot.component.html',
  styleUrl: './advertiser-forgot.component.css',
})
export class AdvertiserForgotComponent {
  forgotObj: any = {
    email: '',
  };
