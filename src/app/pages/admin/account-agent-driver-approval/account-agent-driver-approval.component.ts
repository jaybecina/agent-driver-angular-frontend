...
@Component({
  selector: 'app-account-agent-driver-approval',
  templateUrl: './account-agent-driver-approval.component.html',
  styleUrl: './account-agent-driver-approval.component.css',
})
export class AccountAgentDriverApprovalComponent {
