...
export const customInterceptor: HttpInterceptorFn = (req, next) => {
  ...
  const spinnerLoaderSrv = inject(SpinnerLoaderService);
  ...
  spinnerLoaderSrv.requestStarted();
  ...
  return next(cloneRequest).pipe(
    ...
    // Stop the spinner loader on successful response
    finalize(() => spinnerLoaderSrv.requestEnded())
  );
